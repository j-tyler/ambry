 ...
 *
 * <p>This class provides a foundation for creating ByteBuf wrappers that only need to override
 * specific methods. Subclasses can extend this and override only the methods they need to customize,
 * rather than implementing the entire ByteBuf interface from scratch.</p>
 *
