...
public class ByteBufTrackerListener extends RunListener {
  ...
  private static final String REGISTRY_CLASS = "com.example.bytebuf.tracker.ObjectTrackerRegistry";
  ...
  /**
   * Register the custom Ambry ByteBuf object handler.
   * This must be called before any tracking happens.
   */
  private void registerCustomHandler() {
    ...
    try {
      ...
      System.out.println("[ByteBufTrackerListener] Registered AmbryByteBufObjectHandler for wrapper class tracking");
